...
void ApplicationWindow::componentComplete()
{
    ...
    nativeInterface->setWindowProperty(handle(), QString("_LUNE_WINDOW_TYPE"), QVariant(windowTypeToString(mType)));
    nativeInterface->setWindowProperty(handle(), QString("_LUNE_APP_ID"), QVariant(QCoreApplication::applicationName()));
}
